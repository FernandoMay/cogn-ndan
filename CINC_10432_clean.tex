...
\affil{Instituto Politécnico Nacional, UPIITA, Mexico; Beihang University (BUAA), China.\\Corresponding author: \email{fmayf1500@alumno.ipn.mx}; ORCID: \href{https://orcid.org/0009-0002-3953-5224}{0009-0002-3953-5224}.}
...
\added{Figure~\ref{fig:architecture} summarizes these layers and the feedback boundary. The arrows denote protocol interfaces proposed by this manuscript, not measured control-loop performance.}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig1_architecture.pdf}
\caption{\added{Conceptual COGN-NDAN architecture. The three layers exchange intent, policy, and feedback information in a proposed closed loop; the diagram is architectural and not an empirical result.}}
...
\added{The proposed packet fields and routing sequence are shown in Figure~\ref{fig:packet}.}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig2_packet_workflow.pdf}
\caption{\added{Conceptual semantic packet and routing workflow. Header fields carry intent and policy metadata to a routing decision; integrity verification and quarantine are protocol states, not measured security results.}}
\label{fig:packet}
\end{figure}
...
\added{Figure~\ref{fig:boundary} identifies what can be reproduced from the repository and what remains a future evaluation requirement.}

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig3_boundary.pdf}
\caption{\added{Repository demonstrator and reproducibility boundary. Browser behavior and procedural signals are available from source; empirical validation artifacts are explicitly outside the present repository.}}
\label{fig:boundary}
\end{figure}
...
\section*{Funding}
\added{This research received no external funding.}

\section*{Ethical Statement}
The repository contains no human-participant experiment or animal experiment. EEG-like signals in the demonstrator are procedurally generated for visualization; therefore, animal-experiment reporting is not applicable.
...
\bibitem{strinati2021} Calvanese Strinati, E., \& Barbarossa, S. (2021). 6G networks: Beyond Shannon towards semantic and goal-oriented communications. \textit{Computer Networks, 190}, 107930. \url{https://doi.org/10.1016/j.comnet.2021.107930}

\bibitem{li2022semantic} Iyer, S., Khanai, R., Torse, D., Pandya, R. J., Rabie, K. M., Pai, K., Khan, W. U., \& Fadlullah, Z. (2022). A survey on semantic communications for intelligent wireless networks. \textit{Wireless Personal Communications, 129}(1), 569--611. \url{https://doi.org/10.1007/s11277-022-10111-7}
...
\bibitem{alexandropoulos2021ris} Alexandropoulos, G. C., Shlezinger, N., \& del Hougne, P. (2021). Reconfigurable intelligent surfaces for rich scattering wireless communications: Recent experiments, challenges, and opportunities. \textit{IEEE Communications Magazine, 59}(6), 28--34. \url{https://doi.org/10.1109/MCOM.001.2001117}

\bibitem{yuan2021ris} Yuan, X., Zhang, Y.-J. A., Shi, Y., Yan, W., \& Liu, H. (2021). Reconfigurable-intelligent-surface empowered wireless communications: Challenges and opportunities. \textit{IEEE Wireless Communications, 28}(2), 136--143. \url{https://doi.org/10.1109/MWC.001.2000256}
